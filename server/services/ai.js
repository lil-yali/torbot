...
חוקים:
- כשמבקש לראות תורים — action:"list". קבע when רק לפי מה שנאמר במפורש: "היום"→today, "מחר"→tomorrow, "השבוע"→week, יום/תאריך מסוים→date. בקשה כללית כמו "איזה תורים יש לי" או "מה התורים שלי" (בלי מסגרת זמן) → when:"all".
